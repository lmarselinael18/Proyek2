				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Data Ketua Magang</li>
						</ul><!-- /.breadcrumb -->
											...
											<table id="simple-table" class="table table-striped table-bordered table-hover">
												...
												<?php foreach ($user as $key) { ?>
													<tr>
														...
														<td class="center">
															<?php echo $key['no_telpon']?>
														</td>
														<td>
															<?php echo $key['email']?>
														</td>
														<td><img src="<?php echo base_url(); ?>images/user/<?php echo ($key['photo'])?>" width="100px" height="100px" title="<?php echo ($key['photo'])?>">
															<!-- <?php echo $key['photo']?> -->
														</td>
