				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo site_url(); ?>/admin/edituser/<?php echo $user->UAID; ?>" enctype="multipart/form-data" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="up_nama_admin" value="<?php echo $user->nama_admin; ?>" placeholder="Username" class="col-xs-10 col-sm-5 input-reset"  />
										</div>
									</div>
