			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div id="ModalEditProfil<?php echo $key['UAID'];?>" role="dialog" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-title" align="center">
										<h2>EDIT PROFIL</h2> 
									</div>
									<form action="<?php echo site_url(); ?>/admin/edituser/<?php echo $key['UAID']; ?>" enctype="multipart/form-data" method="post">
									<div class="modal-body">
										<input type="text" class="form-control ins" placeholder="Username" value="<?php echo $key['username'];?>" id="username" name="up_username"><br>
										<input type="password" class="form-control ins" placeholder="Password" value="<?php echo $key['password'];?>" id="password" name="up_password"><br>
										<input type="text" class="form-control ins" placeholder="Nama Admin" value="<?php echo $key['nama_admin'];?>" id="nama_admin" name="up_nama_admin"><br>
										<br>
									...
									<div class="modal-footer">
										<button class="width-15 pull-left btn btn-warning ">
											<a href="<?php echo site_url(); ?>/admin/index" style="color: white;">cancel</a>
										</button>
						...
						<center><h1><b>SELAMAT DATANG ADMIN</b></h1></center>
