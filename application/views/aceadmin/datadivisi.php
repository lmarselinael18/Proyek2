				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Data Kuota Divisi</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
									...
									<div class="ace-settings-item">
										<div class="pull-left">
											<select id="skin-colorpicker" class="hide">
												...
												<option data-skin="skin-4" value="#e4ff00">#e4ff00</option>
											</select>
										</div>
						...
						<div id="ModalEdit<?php echo $key['id_divisi'];?>" role="dialog" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-title" align="center">
									...
									<div class="modal-body">
										<input type="text" class="form-control ins" placeholder="Nama Divisi" value="<?php echo $key['nama_divisi'];?>" id="nama_divisi" name="nama_divisi" readonly><br>
										<input type="text" class="form-control ins" placeholder="Kuota" value="<?php echo $key['kuota'];?>" id="kuota" name="up_kuota"><br>
										<label>Januari</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Januari" value="<?php echo $key['K01'];?>" id="01" name="01"><br>
										<label>Februari</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Februari" value="<?php echo $key['K02'];?>" id="02" name="02"><br>
										<label>Maret</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Maret" value="<?php echo $key['K03'];?>" id="03" name="03"><br>
										<label>April</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota April" value="<?php echo $key['K04'];?>" id="04" name="04"><br>
										<label>Mei</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Mei" value="<?php echo $key['K05'];?>" id="05" name="05"><br>
										<label>Juni</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Juni" value="<?php echo $key['K06'];?>" id="06" name="06"><br>
										<label>Juli</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Juli" value="<?php echo $key['K07'];?>" id="07" name="07"><br>
										<label>Agustus</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Agustus" value="<?php echo $key['K08'];?>" id="08" name="08"><br>
										<label>September</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota September" value="<?php echo $key['K09'];?>" id="09" name="09"><br>
										<label>Oktober</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Oktober" value="<?php echo $key['K10'];?>" id="10" name="10"><br>
										<label>November</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota November" value="<?php echo $key['K11'];?>" id="11" name="11"><br>
										<label>Desember</label> <br>
										<input type="number" class="form-control ins" placeholder="Kuota Desember" value="<?php echo $key['K12'];?>" id="12" name="12"><br>
									...
									<div class="modal-footer">
										<button class="width-15 pull-left btn btn-warning ">
											<a href="<?php echo site_url(); ?>/admin/divisi" style="color: white;">cancel</a>
										</button>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">										
																<a id="edit" class="green" data-toggle="modal" href="#ModalEdit<?php echo $key['id_divisi'];?>">
