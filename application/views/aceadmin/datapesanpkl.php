				...
				<div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            ...
                            <a target="_blank" href="<?php echo site_url(); ?>/admin/PrintLaporan">
                            <button class="btn-success"> Print Laporan
                            </button>
                            </a>
                        ...
                        <div id="inputModal2" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-title" align="center">
										<h2>EDIT DATA USER</h2> 
									</div>
									<!-- <form action="<?php echo site_url(); ?>/admin2/editadmin/<?php echo $user[0]['UAID']; ?>" enctype="multipart/form-data" method="post">
									<div class="modal-body">
										<input type="text" class="form-control ins" value="<?php echo $user[0]['username'];?>" id="username" name="up_username"><br>
										<input type="password" class="form-control ins" value="<?php echo $user[0]['password'];?>" id="password" name="up_password"><br>
										<input type="text" class="form-control ins" value="<?php echo $user[0]['id_divisi']?>" id="id_divisi" name="up_id_divisi"><br>
										<input type="text" class="form-control ins" value="<?php echo $user[0]['nama_admin']?>" id="nama_admin" name="up_nama_admin"><br>
										<br>
										<input type="hidden" value="submit" name="update">
									</div>
											...
											<table id="simple-table" class="table table-striped table-bordered table-hover">
												...
												<?php foreach ($user as $key) { ?>
													...
													<?php echo $key['nama_user']?>
														...
														<td class="center">
															<?php echo $key['jml_pkl']?>
														</td>
														<td>
															<!-- <a title="<?php echo ($key['srt_pengantar'])?>" type="text" href="<?php echo base_url(); ?>images/news/<?php echo ($key['srt_pengantar'])?>"><?php echo ($key['srt_pengantar'])?>
															</a>-->
															 <?php echo $key['srt_pengantar']?>
															 

														</td>
														<td>
															<a class="btn btn-primary btn-sm" download="<?php echo substr($key['srt_pengantar'], 0, 150)?>" title="<?php echo substr($key['srt_pengantar'], 0, 150)?>" type="button" href="<?php echo base_url(); ?>images/news/<?php echo substr($key['srt_pengantar'], 0, 150)?>">Unduh</a>
														</td>
