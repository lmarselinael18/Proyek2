		...
		<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div id="ModalEdit<?php echo $this->session->userdata('UID');?>" role="dialog" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-title" align="center">
										<h2>UPLOAD LAPORAN MAGANG</h2> 
									</div>
									<form action="<?php echo site_url();?>/writer2/createlaporan/<?php echo $this->session->userdata('UID') ?>" enctype="multipart/form-data" method="post">
									<div class="modal-body">
										<input type="text" class="form-control ins" placeholder="Nama User" value="<?php echo $news1[0]['nama_user'];?>" id="nama_admin" name="up_nama_user" readonly><br>
										<input type="file" class="form-control ins" name="up_laporan">
										<br>
									...
									<div class="modal-footer">
										<button class="width-15 pull-left btn btn-warning ">
											<a href="<?php echo site_url(); ?>/writer2/indexlaporan" style="color: white;">cancel</a>
										</button>
										<input name="update" id="submitFormups" type="submit" value="Upload" class="btn btn-success">
									</div>
									</form>
								</div>
							</div>
								...
								<!-- 	<div class="col-xs-12">
										...
										<div class="table-responsive"> 
											...
											<table id="simple-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php foreach ($news1 as $key) { ?>
													<tr>
															<td title="<?php echo $key['nama_user']?>"><?php echo substr($key['nama_user'], 0, 10)?></td>
															<td><?php echo substr($key['laporan'], 0, 150)?></td>
															<td>
															<a id="upload" title ="Upload" class="blue" data-toggle="modal" href="#ModalEdit<?php echo $this->session->userdata('UID');?>">
																	<i class="ace-icon fa fa-cloud-upload bigger-200"></i>
															</a>
															<a id="donwload" title="Download" class="green" download="<?php echo substr($key['laporan'], 0, 150)?>" href="<?php echo base_url(); ?>images/news/<?php echo substr($key['laporan'], 0, 150)?>">
																	<i class="ace-icon fa fa-cloud-download bigger-200"></i>
															</a>
															</td>
