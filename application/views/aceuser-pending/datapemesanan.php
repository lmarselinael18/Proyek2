				...
				<div class="main-content-inner">
					...
					<div class="page-content">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<input type="number" min="0" step="1" max="<?php $this->writermodel->hitung_sisa($key['id_divisi'], $key['tgl_mulai'], $key['tgl_selesai']); ?>" class="form-control ins <?php echo $key['id_pkl'] . "_jumlah"; ?>" placeholder="Jumlah Magang" value="<?php echo $key['jml_pkl'];?>" id="jml_pkl" name="jml_pkl"><br>
						...
						<a href="<?php echo site_url(); ?>/writer/createnews">
							<button class="btn-success"> Pesan Magang
							</button>
						</a>
						<?php } ?>
						<br><br>
