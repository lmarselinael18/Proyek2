				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo site_url(); ?>/writer/createnews" enctype="multipart/form-data" method="post">

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Dinas</label>
											<div class="col-sm-9">
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="date" id="tgl_mulai" name="tgl_mulai"  class="col-xs-11 col-sm-11" required min="<?php echo date('Y-m-d', time()); ?>"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="date" id="tgl_selesai" name="tgl_selesai" class="col-xs-11 col-sm-11" required min="<?php echo date('Y-m-d', time()); ?>"/>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Surat Rekomendasi </label>

										<div class="col-sm-9">
											<input type="file" name="srt_pengantar" id="form-field-2" class="col-xs-10 col-sm-5" required /> (File berbentuk .docx / .doc / .pdf Maksimal 2 MB)
										</div> 
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Jumlah Anggota Kelompok </label>

										<div class="col-sm-9">
											<input type="number" name="Jumlah_peserta" min="1" step="1" id="Jumlah_peserta" placeholder="Jumlah Anggota" class="col-xs-10 col-sm-5" required />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Sisa Kuota </label>

										<div id="sisakuota" class="col-sm-9">
