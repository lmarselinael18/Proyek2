...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Peserta - CV Birudeun</title>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				...
				<ul class="nav nav-list">  
					<li class=""> 
						<a href="<?=base_url()?>index.php/writer2/index">
					...
					<li class="">
						<a href="<?=base_url()?>index.php/writer2/indexlaporan">
							<i class="menu-icon fa fa-file-word-o"></i>
							<span class="menu-text">Upload Lap. Akhir</span>
						</a>

					<li class="">
						<a href="<?=base_url()?>index.php/writer2/edituser/<?php echo $this->session->userdata('UID') ?>">
