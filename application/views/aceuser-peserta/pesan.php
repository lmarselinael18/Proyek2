								...
								<form class="form-horizontal" role="form" action="<?php echo site_url(); ?>/writer/createnews" enctype="multipart/form-data" method="post">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Dinas</label>
											<div class="col-sm-9">
											<select name="id_divisi" id="divisi" class="chosen-select" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="jml_pkl" id="form-field-2" name=""  placeholder="Jumlah Anggota" class="col-xs-10 col-sm-5" />
										</div>
									</div>


									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Surat Pengantar </label>

										<div class="col-sm-9">
											<input type="file" name="srt_pengantar" id="form-field-2" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="date" id="form-field-1" name="tgl_mulai" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="date" id="form-field-1" name="tgl_selesai" class="col-xs-10 col-sm-5" />
										</div>
									</div>
